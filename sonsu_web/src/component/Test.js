...
,ShowResultBtn,NextBtn,TestWord,CurWordHeadDiv,CurWord,PlayTestWords,PlayTestWord,NextDiv,CurWordHead,
HeadWord,HeadWord2,} from '../component_css/Test_style'
    ...
    return (
        ...
        <PlayVideos>
            ...
            <MenuBar>
                <MenuDiv>
                    <CurWordHead>
                        <HeadWord>{currentnumber}/{wordslength}</HeadWord> 
